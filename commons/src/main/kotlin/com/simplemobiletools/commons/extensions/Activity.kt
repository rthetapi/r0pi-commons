...
import com.r0pi.commons.dialogs.*
import com.r0pi.commons.helpers.*
import com.r0pi.commons.models.*
import com.r0pi.commons.views.MyTextView
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.r0pi.gallery.pro" || applicationId == "com.r0pi.gallery.pro.debug") {
