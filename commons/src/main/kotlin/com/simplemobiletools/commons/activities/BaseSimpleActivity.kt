...
import com.r0pi.commons.asynctasks.CopyMoveTask
import com.r0pi.commons.dialogs.ConfirmationDialog
import com.r0pi.commons.dialogs.ExportSettingsDialog
import com.r0pi.commons.dialogs.FileConflictDialog
import com.r0pi.commons.dialogs.WritePermissionDialog
import com.r0pi.commons.extensions.*
import com.r0pi.commons.helpers.*
import com.r0pi.commons.interfaces.CopyMoveListener
import com.r0pi.commons.models.FAQItem
import com.r0pi.commons.models.FileDirItem
import java.io.File
import java.util.*
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.r0pi.", true)) {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.r0pi")) {
            callback(true)
            false
        ...
        handlePermission(PERMISSION_WRITE_STORAGE) {
            if (it) {
                ...
                if (defaultFilename.isEmpty()) {
                    val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.r0pi.")
